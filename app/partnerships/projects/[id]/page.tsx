...
export default function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const projectLinks = trackedLinksData.links.filter(link => link.projectId === id);
    ...
    return (
        <div className="mx-auto max-w-7xl">
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="hover:bg-transparent">
                                    <TableHead className="font-normal text-[var(--text-muted)] text-left">Platform</TableHead>
                                        ...
                                        <TableRow key={s.platform}>
                                            ...
                                            <TableCell
                                                className={`text-right font-medium ${
                                                    s.followers.startsWith('-') ? 'text-[var(--color-red)]' : 'text-[var(--color-green)]'
                                                }`}
                                            >
                                                {s.followers}
                                            </TableCell>
            ...
            <Card className="mt-6">
                ...
                <CardContent>
                    <Table>
                        <TableHeader>
                            <TableRow className="hover:bg-transparent">
                                <TableHead className="font-normal text-[var(--text-muted)] text-left">Content</TableHead>
                                <TableHead className="font-normal text-[var(--text-muted)] text-left">Author</TableHead>
                                <TableHead className="font-normal text-[var(--text-muted)] text-left">Date</TableHead>
                                <TableHead className="text-right font-normal text-[var(--text-muted)]">Views</TableHead>
                                <TableHead className="text-right font-normal text-[var(--text-muted)]">Eng.</TableHead>
            ...
            {projectLinks.length > 0 && (
                <>
                    <h2 className="mt-10 text-xl font-bold">Tracking Links</h2>
                    <p className="mt-1 text-sm text-[var(--text-muted)]">Custom tracked URLs generated for this campaign and their performance.</p>
                    <Card className="mt-4 overflow-hidden border-none bg-white/50 backdrop-blur-sm">
                        <Table>
                            <TableHeader>
                                <TableRow className="hover:bg-transparent">
