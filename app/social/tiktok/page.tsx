...
import { TiktokTable } from '@/app/components/social/social-tables';
import { SiTiktok } from '@/app/components/social/social-icons';
import tiktokData from '@/data/tiktok.json';
import { ChartConfig } from '@/app/components/ui/chart';

const { statsData, followerGrowthData, interactionsData, topTiktoks } =
  tiktokData;
...
const growthConfig = {
  followers: { label: 'Followers', color: '#3a675b' },
