...
import { TwitterTable } from '@/app/components/social/social-tables';
import { SiTwitter } from '@/app/components/social/social-icons';
import twitterData from '@/data/twitter.json';
import { ChartConfig } from '@/app/components/ui/chart';

const { statsData, followerGrowthData, engagementData, topTweets } =
  twitterData;
...
const growthConfig = {
  followers: { label: 'Followers', color: '#abceb9' },
    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mt-6 grid grid-cols-2 gap-6">
        <SocialGrowthChart
          ...
          description="Evolution over the last 12 months"
        ...
        <SocialEngagementChart
          ...
          description="Likes, retweets and replies"
          data={engagementData}
          xAxisKey="day"
          bars={engBars}
          config={engConfig}
