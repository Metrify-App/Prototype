...
const getPlatformIcon = (platform: string) => {
  switch (platform) {
    case 'Twitter':
      return <SiTwitter size={14} />;
    case 'Instagram':
      return <SiInstagram size={14} />;
    case 'YouTube':
      return <SiYoutube size={14} />;
    case 'Twitch':
      return <SiTwitch size={14} />;
    case 'TikTok':
      return <SiTiktok size={14} />;
    default:
        ...
        <Card className="shadow-none border-[var(--border-light)] overflow-hidden">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-xs truncate">
              Total followers/subscribers per network
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
            <ChartContainer
              config={audienceConfig}
              className="aspect-[21/5] w-full"
            >
              <BarChart
                data={platformData}
                    ...
                    <TableCell>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <span className="truncate max-w-[250px] text-sm text-[var(--text-secondary)]">
                            {mention.message}
                          </span>
                        </div>
                      </div>
                  ...
                  >
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="truncate max-w-[200px] font-medium text-sm text-[var(--text-primary)]">
                          {post.content}
                        </span>
                      </div>
                    </TableCell>
