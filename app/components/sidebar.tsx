...
import { BarChart3, FolderOpen, Home, Link as LinkIcon, MoreVertical, Pin, Plus, Settings, Users } from 'lucide-react';

import Image from 'next/image';
import Link from 'next/link';

import { SiInstagram, SiTiktok, SiTwitch, SiTwitter, SiYoutube } from './social/social-icons';
...
function SectionHeader({ label, hasAdd, addHref }: { label: string; hasAdd?: boolean; addHref?: string }) {
    return (
