                        ...
                        {data.map((tweet) => (
                            <TableRow key={tweet.id} className="border-[var(--border-light)]">
                                ...
                                <TableCell className="text-right">
                                    <span className="inline-flex items-center rounded bg-[var(--color-green-light)] px-2 py-0.5 text-xs font-semibold text-[var(--color-green)]">{tweet.engagement}</span>
                                </TableCell>
                    ...
                    <TableBody>
                        {data.map((post) => (
                            <TableRow key={post.id} className="border-[var(--border-light)]">
                                ...
                                <TableCell className="text-right">
                                    <span className="inline-flex items-center rounded bg-[var(--color-green-light)] px-2 py-0.5 text-xs font-semibold text-[var(--color-green)]">{post.engagement}</span>
                                </TableCell>
                    ...
                    <TableBody>
                        {data.map((video) => (
                            <TableRow key={video.id} className="border-[var(--border-light)]">
                                ...
                                <TableCell className="text-right">
                                    <span className="inline-flex items-center rounded bg-[var(--color-green-light)] px-2 py-0.5 text-xs font-semibold text-[var(--color-green)]">{video.ctr}</span>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
