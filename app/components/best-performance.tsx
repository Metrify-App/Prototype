...
import { SiTwitter, SiYoutube } from './social-icons';
        ...
        <Table className="mt-4">
            <TableHeader>
                <TableRow className="hover:bg-transparent">
                    <TableHead className="text-[var(--text-muted)] font-normal">Titre</TableHead>
                    <TableHead className="text-right text-[var(--text-muted)] font-normal">View</TableHead>
                    <TableHead className="text-right text-[var(--text-muted)] font-normal">Rate</TableHead>
                    <TableHead className="text-right text-[var(--text-muted)] font-normal">Engagement</TableHead>
                </TableRow>
            </TableHeader>
            <TableBody>
                {data.map((perf) => {
